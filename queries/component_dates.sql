SELECT archival_object.title AS component_title, resource.title AS resource_title, resource.ead_id, date.expression, date.begin, date.end, date.date_type_id, date.label_id, date.certainty_id, date.calendar_id, date.era_id, enumeration_value.value
